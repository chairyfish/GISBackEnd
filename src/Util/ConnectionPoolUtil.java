...
public class ConnectionPoolUtil {
    ...
    private static volatile ConnectionPoolUtil connectionPoolUtil;
    private ComboPooledDataSource cpds;

    private ConnectionPoolUtil() {
        String driverClassName = "com.mysql.jdbc.Driver";
        String url = "jdbc:mysql://112.74.173.33:3306/GISProject?useSSL=false&useUnicode=true&characterEncoding=UTF8";
        String username = "REMOTEUSER";
        String password = "961219";
    ...
    public static ConnectionPoolUtil getInstance() {
        if (connectionPoolUtil == null) {
            synchronized (ConnectionPoolUtil.class) {
                if (connectionPoolUtil == null) {
                    connectionPoolUtil = new ConnectionPoolUtil();
                }
            }
        }
