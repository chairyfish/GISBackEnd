...
<table>
    ...
    <tr>
        ...
        <td class="d"><a href="http://112.74.173.33/GISBackEnd/login?number=20141001143&password=123456">示例</a></td>
    </tr>
    <tr>
        <td class="a">用户注册</td>
        ...
        <td class="d"><a
                href="http://112.74.173.33/GISBackEnd/regist?number=20141001143&name=董欣怡&password=123456">示例</a></td>
    </tr>
    <tr>
        ...
        <td class="d"><a href="http://112.74.173.33/GISBackEnd/test">示例</a></td>
    </tr>
    <tr>
        <td class="a">bname查询建筑物</td>
        <td class="b">http://112.74.173.33/GISBackEnd/buildingbyname</td>
        <td class="c">bname</td>
        <td class="d"><a href="http://112.74.173.33/GISBackEnd/buildingbyname?bname=体育馆">示例</a></td>
    </tr>
    <tr>
        <td class="a">bid查询建筑物</td>
        <td class="b">http://112.74.173.33/GISBackEnd/buildingbyid</td>
        <td class="c">bid</td>
        <td class="d"><a href="http://112.74.173.33/GISBackEnd/buildingbyid?bid=12">示例</a></td>
    </tr>
    <tr>
        <td class="a">bfunc查询建筑物</td>
        <td class="b">http://112.74.173.33/GISBackEnd/buildingbyfunc</td>
        <td class="c">bfunction</td>
        <td class="d"><a href="http://112.74.173.33/GISBackEnd/buildingbyfunc?bfunction=羽毛球">示例</a></td>
    </tr>
    <tr>
        <td class="a">btype查询建筑物</td>
        <td class="b">http://112.74.173.33/GISBackEnd/buildingbytype</td>
        <td class="c">btype</td>
        <td class="d"><a href="http://112.74.173.33/GISBackEnd/buildingbytype?btype=活动场地">示例</a></td>
    </tr>
    <tr>
        <td class="a">bid查询设备</td>
        <td class="b">http://112.74.173.33/GISBackEnd/equipmentbybid</td>
        <td class="c">bid</td>
        <td class="d"><a href="http://112.74.173.33/GISBackEnd/equipmentbybid?bid=1">示例</a></td>
    </tr>
    <tr>
        <td class="a">新增报修</td>
        ...
        <td class="d"><a
                href="http://112.74.173.33/GISBackEnd/addfix?ename=课桌&bname=教三楼&fhousenumber=301&uid=1&ftel=13110002000&fremark=课桌更换">示例</a>
        </td>
    </tr>
    <tr>
        ...
        <td class="c">uid</td>
        <td class="d"><a href="http://112.74.173.33/GISBackEnd/fixbyuid?uid=1">示例</a></td>
    </tr>
    <tr>
        <td class="a">查询所有报修信息*</td>
        <td class="b">http://112.74.173.33/GISBackEnd/fixall</td>
        <td class="c">无</td>
        <td class="d"><a href="http://112.74.173.33/GISBackEnd/fixall">示例</a></td>
    </tr>
    <tr>
        <td class="a">报修信息分页查询*</td>
        <td class="b">http://112.74.173.33/GISBackEnd/fixpage</td>
        <td class="c">p(页码)</td>
        <td class="d"><a href="http://112.74.173.33/GISBackEnd/fixpage?p=2">示例</a></td>
    </tr>
    <tr>
        ...
        <td class="d"><a
                href="http://112.74.173.33/GISBackEnd/fixbytime?starttime=2016-01-01&endtime=2016-04-01&p=2">示例</a></td>
    </tr>
    <tr>
        <td class="a">bid查询活动信息</td>
        <td class="b">http://112.74.173.33/GISBackEnd/activitybybid</td>
        <td class="c">bid</td>
        <td class="d"><a href="http://112.74.173.33/GISBackEnd/activitybybid?bid=18">示例</a></td>
    </tr>
    <tr>
        <td class="a">查询某教室今天的状态</td>
        <td class="b">http://112.74.173.33/GISBackEnd/roomstate</td>
        <td class="c">bname,cnumber</td>
        <td class="d"><a href="http://112.74.173.33/GISBackEnd/roomstate?bname=教二楼&cnumber=307">示例</a></td>
    </tr>
    <tr>
        <td class="a">某建筑某节课无课的教室</td>
        <td class="b">http://112.74.173.33/GISBackEnd/emptyclass</td>
        <td class="c">bname,classnum</td>
        <td class="d"><a href="http://112.74.173.33/GISBackEnd/emptyclass?bname=教三楼&classnum=2">示例</a></td>
    </tr>
</table>
</body>
